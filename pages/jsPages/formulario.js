...
const q1 = {
    numQuestao   : 1,
    pergunta     : "O primeiro passo para o investimento é...",
    alternativaA : "Deixar de comprar algo",
    alternativaB : "Comprar um cofrinho",
    alternativaC : "Criar uma reserva",
    correta      : "Criar uma reserva",
}

const q2 = {
    numQuestao   : 2,
    pergunta     : " Oque é investir?",
    alternativaA : "É poupar o dinheiro",
    alternativaB : "É realizar um gasto no presente para ter um retorno no futuro",
    alternativaC : "É economizar no presente para utilziar no futuro",
    correta      : "É realizar um gasto no presente para ter um retorno no futuro",
}
