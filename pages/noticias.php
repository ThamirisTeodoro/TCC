...
<section class="header-noticias">
	<div class="center">
		...
		<h2 style="font-size: 21px;">Acompanhe as últimas informações sobre <b>Educação Financeira infantil</b></h2>
	</div><!--center-->
</section>
					...
					<form>
						...
						<option value="" selected="">Todas as categorias</option>
							...
							?>
								...
								value="<?php echo $value['slug'] ?>"><?php echo $value['nome']; ?></option>
							<?php } ?>
