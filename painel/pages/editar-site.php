...
<div class="box-content">
	...
	<form method="post" enctype="multipart/form-data">
		...
		<div class="form-group">
			...
			<input type="text" name="image<?php echo $i; ?>" value="<?php echo $site['image'.$i] ?>" />
		</div><!--form-group-->
		<div class="form-group">
			<label>titulo_topicos<?php echo $i; ?>:</label>
			<input type="text" name="titulo_topicos<?php echo $i; ?>" value="<?php echo $site['titulo_topicos'.$i] ?>" />
		</div><!--form-group-->
